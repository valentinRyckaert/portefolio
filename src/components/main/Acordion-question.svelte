        ...
        <div id="collapseThree" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
            <div class="accordion-body">
                <p>
                    ...
                    La lecture de certaines polices (surtout petites) me demandent plus d'effort que la moyenne.
                    Mais j'ai découvert le projet open source OpenDyslexic, qui propose des polices adaptées aux personnes ayant des problèmes de lecture.
                </p>
                <p>
